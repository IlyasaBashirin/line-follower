...
basic.forever(function () {
    if (Tinybit.Line_Sensor(Tinybit.enPos.LeftState, Tinybit.enLineState.White) && Tinybit.Line_Sensor(Tinybit.enPos.RightState, Tinybit.enLineState.White)) {
        ...
        Tinybit.CarCtrlSpeed(Tinybit.CarState.Car_SpinLeft, 40)
        ...
        Tinybit.CarCtrlSpeed(Tinybit.CarState.Car_SpinRight, 40)
    } else {
        Tinybit.CarCtrlSpeed(Tinybit.CarState.Car_SpinRight, 0)
    }
})
